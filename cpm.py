...
if (choose == "CPM"):
    ...
    st.title("Operational Slip (OS) Data")
    ...
    freq_slider_start, freq_slider_end = st.slider("You can drag the slider to the frequency that you want", 50, 100000, (100000, 500))
